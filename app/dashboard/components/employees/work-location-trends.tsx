...
const WorkLocationTrends = () => {
  return (
    <ResponsiveContainer height={350} width="100%">
        <BarChart className='[&_.recharts-tooltip-cursor]:fill-zinc-200 dark:[&_.recharts-tooltip-cursor]:fill-zinc-800' data={data}>
          ...
          }} labelClassName='font-bold' wrapperClassName='!text-sm dark:!bg-black rounded-md dark:!border-border' />
          <Legend iconType='circle' formatter={(value) => {
            ...
            <Bar dataKey="office" stackId={1} fill='#4bad93' />
